...
public class FuelQueue {
    static int waitingqueueIndex = 0;
    public static int total_income=0;


    public static Scanner input = new Scanner(System.in);

    public static void initialise(Passenger[][] array1, WaitingQueue[] waitingqueue) {  //Initialise
        ...
        for (int m = 0; m < 3; m++) {
            waitingqueue[m] = new WaitingQueue("empty", "empty", "empty",0);
        }
    }
    ...
    public static void AddCustomer(Passenger[][] array1, WaitingQueue[] waitingqueue) {    //Add passenger to cabin
        ...
        try {
            ...
            while (true) {
                if (Checkpump(array1)){
                    if (waitingqueueIndex < 6){
                        System.out.println("\nAll Pumps are full\n");
                        System.out.println("Add new Customer to the waiting list:\n");
                        Scanner userInput = new Scanner(System.in);
                        System.out.print("First Name : ");
                        waitingqueue[waitingqueueIndex].setFirstName(userInput.next());
                        System.out.print("Last Name : ");
                        waitingqueue[waitingqueueIndex].setSecondName(userInput.next());
                        System.out.print("Vehicle No : ");
                        waitingqueue[waitingqueueIndex].setVehicleNo(userInput.next());
                        System.out.print("Liters : ");
                        waitingqueue[waitingqueueIndex].setNoLiters(userInput.nextInt());
                ...
                System.out.println();
                System.out.println("         Add customer to a pump");
                System.out.println("------------------------------------");
                System.out.println();
                ...
                if (pumpNumber == 6) {
                    ...
                    if (pumpNumber >= array1.length) {
                        ...
                        AddCustomer(array1,waitingqueue);
                        break;
                    }
                        ...
                        for (CustomerNumber = 1; CustomerNumber < array1[pumpNumber].length; CustomerNumber++) {
                            if (array1[pumpNumber][CustomerNumber].getFirstName().equals("empty")) {
                                if (array1[pumpNumber][CustomerNumber].getFirstName().equals("empty")) {   //Check selected pump is empty
                                    ...
                                    System.out.println("4. No of liters you want : " + array1[pumpNumber][CustomerNumber].getNoliters());

                                } else {
                                    System.out.println();
                                    System.out.println("Pump number " + pumpNumber + " : customer " + CustomerNumber + " is already occupied by " + array1[pumpNumber][CustomerNumber].getFirstName());
                                }
                                AddCustomer(array1,waitingqueue);
                            }
                        }
    ...
    public static void RemoveCustomer(Passenger[][] array1) { // Delete selected customer from Queue
        ...
        for (int pumpNumber = 1; pumpNumber < array1.length; pumpNumber++) {
            for (int CustomerNumber = 1; CustomerNumber < array1[pumpNumber].length; CustomerNumber++) {
                if (array1[pumpNumber][CustomerNumber].getFirstName().equals(removeName)) {   //Check entered name is available in queue
                    ...
                    System.out.println("Cabin " + pumpNumber + " passenger " + CustomerNumber + " : " + removeName + " removed successfully");
        ...
        if (!CustomerFound) {  //If user not available in pump
            System.out.println("There is no passenger found with the name " + removeName);
        }
    ...
    public static void StoreProgram(Passenger[][] array1) throws IOException { //Save array data to Demo.txt file
        ...
        for (int pumpNumber = 1; pumpNumber < array1.length; pumpNumber++) {
            for (int CustomerNumber = 1; CustomerNumber < array1[pumpNumber].length; CustomerNumber++) {
                write.write("\n Customer " + CustomerNumber + "-" + "First Name :  " + array1[pumpNumber][CustomerNumber].getFirstName() + "");
                write.write("\n Customer " + CustomerNumber + "-" + "Second Name :  " +array1[pumpNumber][CustomerNumber].getSecondName());
    ...
    public static void RemainFuel(int totalfuel)  {
        ...
        // can check remaining fuel liters
    ...
    public static void AddFuel(int totalfuel) {
    ...
    public static void incomeFuel(Passenger[][] array1) {
    ...
    public static boolean Checkpump(Passenger[][] array1) {
